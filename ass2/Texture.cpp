...
bool LTexture::loadFromFileTransColor(SDL_Renderer* gRenderer, std::string path, Uint8 red, Uint8 green, Uint8 blue)
{
	//Get rid of preexisting texture
	free();
...
bool LTexture::loadFromRenderedText(SDL_Renderer* rR, TTF_Font* font, std::string textureText, SDL_Color textColor)
{
	//Get rid of preexisting texture
	free();
...
void LTexture::render2(SDL_Renderer* gRenderer, int x, int y, SDL_Rect* clip, double angle, SDL_Point* center, SDL_RendererFlip flip)
{
	//Set rendering space and render to screen
	SDL_Rect renderQuad = { x, y, mWidth, mHeight };
